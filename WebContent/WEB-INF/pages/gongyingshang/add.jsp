		...
		<div class="row">
			...
			<div class="col-md-10 maincon">
				...
				<form id="formpot" class="form-horizontal"
					action="${ctx }/gongyingshang/doadd" method="post">
					<div class="container-fluid">
							...
							<div role="tabpanel" class="tab-pane fade in active" id="jbxx">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="gysyyzzqx"
												name="gysyyzzqx" value="${gys.gysyyzzqx }" />
										</div>
									</div>
									<div class="form-group">
										<label for="gysyyzzfzrq" class="col-md-3 control-label">执照发证日期</label>
										<div class="col-md-8">
											<input type="text" class="form-control" id="gysyyzzfzrq"
												name="gysyyzzfzrq" value="${gys.gysyyzzfzrq }" />
										</div>
									</div>
									<div class="form-group">
							...
							<div role="tabpanel" class="tab-pane" id="gspzl">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="gysgspzjyxq"
												name="gysgspzjyxq" value="${gys.gysgspzjyxq }" />
										</div>
									</div>
									<div class="form-group">
