					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input type="text" class="form-control" id="ksmc" name="ksmc"
								value="${keshi.ksmc }" data-validate="required:请输入名称"/>
						</div>
					</div>
					<div class="form-group">
