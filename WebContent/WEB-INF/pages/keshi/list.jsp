...
<script>
	...
	function del() {
		if($("#tablepot .success").length > 0){	
			if (confirm("您确定要删除 " + $("#tablepot .success td:eq(1)").text() + " 吗?")) {	
				var id = $("#tempid").val();
				location = "${ctx}/keshi/delete?id=" + id;
			}
		}else{
			alert("请先选择科室");
		}
	...
	function walkpage(conpage) {
		if(conpage>0||conpage<=$("#zonpage").text()){
			location="${ctx }/keshi/list?conpage="+conpage;
		}
	}
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-9 maincon">
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown"><a id="drop1" data-toggle="dropdown"
									...
									<ul class="dropdown-menu" aria-labelledby="drop1">
										...
										<li><a href="${ctx }/keshi/downloadexcel">本店记录</a></li>
									</ul></li>
							</ul>
							<form class="navbar-form navbar-right" action="${ctx }/keshi/search"
								method="post">
				...
				<form class="form-inline" action="${ctx }/keshi/list"
